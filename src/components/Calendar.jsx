  ...
  return (
    <div>
      <div className="flex items-center">
        <h2 className="flex-auto text-sm font-semibold text-gray-200">January 2022</h2>
        <button
          type="button"
          ...
          <div key={day.date} className={classNames(dayIdx > 6 && 'border-t border-gray-600', 'py-2')}>
            <button
              ...
              className={classNames(
                ...
                !day.isSelected && !day.isToday && !day.isCurrentMonth && 'text-gray-500',
                day.isSelected && day.isToday && 'bg-sky-400',
                day.isSelected && !day.isToday && 'bg-gray-700',
